...
<div class="main">
	<div class="page_00">
		<div class="first_play">
			...
			<div id="labo2" class="first_play_level">
				<span class="first_icon"></span>
				<span class="first_comm">変更</span>
				<span class="first_comm">-Log-</span>
			</div>

			<a href="./outpost.php" id="labo3" class="first_play_level">
				<span class="first_icon"></span>
			...
			<a href="./outpost.php" id="labo4" class="first_play_level">
				<span class="first_icon"></span>
				<span class="first_comm">ご意見板</span>
				<span class="first_comm">-BBS-</span>
			</a>

			<div id="labo5" class="first_play_level">
				<span class="first_icon"></span>
				<span class="first_comm">制作手記</span>
				<span class="first_comm">-Katsumi-</span>
			</div>
