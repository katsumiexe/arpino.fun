...
<div class="main">
	<div class="howto">
		...
		<div id="box0" class="howto_in">
			...
			<span style="color:#503010">『好感度アイテムカード』</span>を各1枚づつ、計12枚を各プレイヤーに配ります。<bR>
			<span style="color:#503010">『魅力カード』</span>をシャッフルし、裏向けに置いてゲームスタートです。<br>
		</div>
		
		<div id="box1" class="howto_in">
			<div class="howto_title">進行</div>
			ターンのはじめに<span style="color:#503010">『魅力カード』</span>が一枚提示されます。<br>
			各プレイヤーはそれぞれ<span style="color:#503010">『好感度アイテムカード』</span>を一枚捧げます。<br>
			このときに、最も価値の高いものを出した人が<span style="color:#503010">『魅力カード』</span>を獲得できます。<br>
			ただし、同じ<span style="color:#503010">『好感度アイテムカード』</span>を出した人がいた場合はブッキングとなり、対象は次に高い人になります。<br>
			全員がブッキングした場合、その魅力はだれも受け取ることが出来ません。<br>
			一度使った<span style="color:#503010">『好感度アイテムカード』</span>は再度使うことはできません。<br>
		...
		<div id="box3" class="howto_in">
			<div class="howto_title">好感度アイテムカード（12種類）</div>
			王子から頂いたプレゼントでこれを捧げることで、<span style="color:#503010">【魅力ポイント】</span>を獲得することができます。<br>
		...
		<div id="box4" class="howto_in">
			...
			選んだ<span style="color:#503010">『ユニットカード』</span>が持つチャームポイントによって、獲得ポイントが変わるものもあります。<br>
			<br>
			副官任命（1枚）<br>
			魅力ポイント+3<br>
			<br>
		...
		<div class="howto_page">
			...
			<span id="ibox3" class="howto_page_tag">好感度アイテムカード</span>
