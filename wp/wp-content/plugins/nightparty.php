...
if($_POST["staff_set"]){
	...
	if($genji){
		...
		$sql.="('{$tmp_auto}','ドリンクA','0','48','500','1'),";
		$sql.="('{$tmp_auto}','ドリンクB','2','35','1000','2'),";
		$sql.="('{$tmp_auto}','フードA','4','3','500','3'),";
		$sql.="('{$tmp_auto}','フードB','5','7','100','4'),";
		$sql.="('{$tmp_auto}','ボトル','3','36','2000','5'),";
		$sql.="('{$tmp_auto}','本指名','8','55','2000','6'),";
		$sql.="('{$tmp_auto}','場内指名','8','12','500','7'),";
		$sql.="('{$tmp_auto}','同伴','6','59','2000','8')";
		$sql.="('{$tmp_auto}','2ショット','10','40','500','9')";
		$sql.="('{$tmp_auto}','カラオケ','22','60','500','10')";
		$wpdb->query($sql);
	}
}
