...
if(count($tmp)>10){
$html.="<div class=\"blog_ad\"><img src=\"{get_template_directory_uri()}/img/ad/bn.jpg\" style=\"width:100%;\"></div>";
$html.="<div id=\"blog_next_{$blog[11][\"id\"]}\" class=\"blog_next\">続きを読む</div>";
}
